...
!function () {
  ...
  function Y() {}
  for (
    g = { className: "", catchupTime: 100, initialRate: 0.03, minTime: 250, ghostTime: 100, maxProgressPerFrame: 20, easeFactor: 1.25, startOnPageLoad: !0, restartOnPushState: !0, restartOnRequestAfter: 500, target: "body", elements: { checkInterval: 100, selectors: ["body"] }, eventLag: { minSamples: 10, sampleCount: 3, lagThreshold: 3 }, ajax: { trackMethods: ["GET"], trackWebSockets: !0, ignoreURLs: [] } },
      P = function () {
        var t;
  ...
  (B = Error),
    ...
    ($.prototype.getElement = function () {
      ...
      if (null == this.el) {
        ...
        (this.el.innerHTML = '<div class="pace-progress' + e + '">\n  <div class="pace-progress-inner"><div></div><div></div><div></div><div></div><div></div></div>\n</div>\n<div class="pace-activity"></div>'), null != t.firstChild ? t.insertBefore(this.el, t.firstChild) : t.appendChild(this.el);
      }
      return this.el;
    }),
